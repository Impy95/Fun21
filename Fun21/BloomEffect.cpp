...
GEX::BloomEffect::BloomEffect() : shaders_()
, brightnessTexture_()
, firstPassTexture_()
, secondPassTexture_()
{
...
void GEX::BloomEffect::apply(const sf::RenderTexture& input, sf::RenderTarget& output)
{
...
void GEX::BloomEffect::prepareTextures(sf::Vector2u size)
{
...
void GEX::BloomEffect::filterBright(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void GEX::BloomEffect::blurMultipass(RenderTextureArray& renderTextures)
{
...
void GEX::BloomEffect::blur(const sf::RenderTexture& input, sf::RenderTexture& output, sf::Vector2f offsetFactor)
{
...
void GEX::BloomEffect::downsample(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void GEX::BloomEffect::add(const sf::RenderTexture& source, const sf::RenderTexture& bloom, sf::RenderTarget& output)
{
